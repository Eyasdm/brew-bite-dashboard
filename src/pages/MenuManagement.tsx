...
export default function MenuManagement() {
  ...
  /* ------------------ UI state ------------------ */
  const [activeItem, setActiveItem] = useState<MenuItem | "add" | null>(null);
  ...
  /* ------------------ submit handler ------------------ */
  function handleSubmit(data: MenuItemFormData & { price: number }, resetForm: () => void) {
    if (activeItem === "add") {
    ...
    updateMutation.mutate(
      { id: (activeItem as MenuItem).id, payload: data },
