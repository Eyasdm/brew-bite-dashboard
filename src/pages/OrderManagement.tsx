...
/* ------------------ badge mappers ------------------ */
function getStatusBadge(status: string, t: TFunction): { tone: string; label: string } {
  switch (status) {
    case "preparing":
...
function getPaymentBadge(isPaid: boolean, t: TFunction): { tone: string; label: string } {
  return isPaid
